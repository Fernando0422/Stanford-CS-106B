...
STUDENT_TEST("Double negative function queue is equal to -2"){
    Queue<int> q = {-2};
...
STUDENT_TEST("Double negative function queue is equal to -2, -4"){
    Queue<int> q = {-2, -4};
    Queue<int> expected = {-2, -2, -4, -4};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}

STUDENT_TEST("Double negative function queue is equal to 22, 46, -17"){
    Queue<int> q = {22, 46, -17};
    Queue<int> expected = {22, 46, -17, -17};
